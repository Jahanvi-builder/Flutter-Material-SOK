...
const List<MenuItem> menuItems = [
  MenuItem(
    id: 'CMB_NORTH_THALI',
    name: 'Build Your North Indian Thali',
    description:
        'Choose a gravy, bread, rice and starter to build a hearty thali-style meal.',
    price: 339,
    category: 'Combos',
    ...
    comboSlots: [
      ComboSlot(
        ...
        customizationGroupId: 'thali_main',
        required: true,
        defaultOptionId: 'dal_makhani',
        allowedOptionIds: [
          'dal_makhani',
          'paneer_tikka_masala',
          'malai_kofta',
      ...
      ComboSlot(
        ...
        customizationGroupId: 'thali_bread',
        required: true,
        defaultOptionId: 'tandoori_roti',
        allowedOptionIds: [
          'tandoori_roti',
          'butter_naan',
          'garlic_naan',
      ...
      ComboSlot(
        ...
        customizationGroupId: 'thali_rice',
        required: true,
        defaultOptionId: 'jeera_rice',
        allowedOptionIds: [
          'jeera_rice',
          'veg_pulao',
          'chicken_biryani',
      ...
      ComboSlot(
        slotId: 'addon',
        title: 'Choose your add-on',
        customizationGroupId: 'thali_addon',
        required: true,
        defaultOptionId: 'samosa',
        allowedOptionIds: [
          'samosa',
          'mirchi_bajji',
          'paneer_tikka_angare',
    ...
    customizationGroups: [
      MenuItemCustomizationGroup(
        ...
        options: [
          ...
          MenuItemOption(
            ...
            label: 'Malai Kofta',
            priceDelta: 45,
            referencePriceDelta: 240,
            imagePath: 'images/Food/North indian/Malai kofta.jpg',
          ),
          MenuItemOption(
            id: 'murgh_lababdar',
            label: 'Murgh Lababdar',
            priceDelta: 70,
            referencePriceDelta: 280,
      ...
      MenuItemCustomizationGroup(
        ...
        options: [
          ...
          MenuItemOption(
            ...
            priceDelta: 15,
            referencePriceDelta: 150,
            imagePath: 'images/Food/North indian/Veg_pulao.jpg',
          ),
          MenuItemOption(
            id: 'chicken_biryani',
            label: 'Lucknowi Chicken Biryani',
            priceDelta: 65,
            referencePriceDelta: 280,
      ...
      MenuItemCustomizationGroup(
        ...
        options: [
          ...
          MenuItemOption(
            id: 'paneer_tikka_angare',
            label: 'Paneer Tikka Angare',
            priceDelta: 75,
            referencePriceDelta: 240,
  ...
  MenuItem(
    ...
    name: 'Dal Tadka',
    description:
        'Yellow lentils tempered with garlic, cumin, and dry red chilies.',
    price: 160,
    category: 'North Indian',
    subCategory: 'Gravy (Veg)',
    isVeg: true,
  ...
  MenuItem(
    ...
    description:
        'Tandoori chicken pulled and cooked in a velvety butter sauce.',
    price: 320,
    category: 'North Indian',
    subCategory: 'Gravy (Non-Veg)',
    isVeg: false,
